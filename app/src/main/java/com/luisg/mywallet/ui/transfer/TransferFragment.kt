...
import com.luisg.mywallet.ui.TransferProxy
import com.luisg.mywallet.ui.transfer.data.AplicationDatabase
import com.luisg.mywallet.ui.transfer.data.TransferEntity
...
class TransferFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        transferButton.setOnClickListener {
            AplicationDatabase.getAppDatabase(context!!)?.getDAO()?.saveTransfer(TransferEntity(
                userId = "97876",
                userName = "LuisG",
                transactionDate = "12 Dic 2020",
                transactionAmount = "500000",
                receiverUserId = "98776"
            ))

            val runnable = Runnable {
                var userTransferString = ""
                val transferList = AplicationDatabase.getAppDatabase(context!!)?.getDAO()?.findTransferByUserName("LuisG")
